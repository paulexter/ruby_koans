...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    ##In case .send is overwritten by another user-defined method
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    ## we can add functionality to method_missing for a class,
    ## so that calling an unknown method will effectively run another method.
    #
    # NOTE:
    #
